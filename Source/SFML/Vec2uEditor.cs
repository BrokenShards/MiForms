...
{
	/// <summary>
	///   Control for editing Vector2u.
	/// </summary>
	[ToolboxItem( true )] [DesignTimeVisible( true )]
	public partial class Vec2uEditor : MiControl, IComponent
	{
		/// <summary>
		///   Constructor.
		/// </summary>
		...
		///   Maximum value.
		/// </param>
		public Vec2uEditor( uint min, uint max )
		:	this()
		{
			MinXValue = min;
			MinYValue = min;
		...
		///   Maximum value.
		/// </param>
		public Vec2uEditor( Vector2u val, uint min = 0, uint max = uint.MaxValue )
		:	this( min, max )
		{
			XValue = val.X;
			YValue = val.Y;
		...
		///   Maximum value.
		/// </param>
		public Vec2uEditor( string label, Vector2u val = default, uint min = 0, uint max = uint.MaxValue )
		:	this( val, min, max )
		{
			Label = label;
		}
		...
		///   Minimum X value.
		/// </summary>
		public uint MinXValue
		{
			get { return (uint)xBox.Minimum; }
			set { xBox.Minimum = value; }
		}
		/// <summary>
		///   Minimum X value.
		/// </summary>
		public uint MaxXValue
		{
			get { return (uint)xBox.Maximum; }
		...
		///   Minimum Y value.
		/// </summary>
		public uint MinYValue
		{
			get { return (uint)yBox.Minimum; }
			set { yBox.Minimum = value; }
		}
		/// <summary>
		///   Minimum Y value.
		/// </summary>
		public uint MaxYValue
		{
			get { return (uint)yBox.Maximum; }
