...
namespace MiForms
{
	...
	public partial class FileLoader : MiControl, IComponent
	{
		/// <summary>
		///   Constructor.
		/// </summary>
		...
		{
			get { return openDialog.DefaultExt; }
			set { openDialog.DefaultExt = value; }
		}
		/// <summary>
		...
		{
			get { return openDialog.InitialDirectory; }
			set { openDialog.InitialDirectory = value; }
		}
		/// <summary>
		///   Current path string.
		/// </summary>
