...
{
	/// <summary>
	///   A component that contains a path bar and a button that opens a dialog to select a file.
	/// </summary>
	[ToolboxItem( true )] [DesignTimeVisible( true )]
	public partial class FileSaver : MiControl, IComponent
	{
		/// <summary>
		///   Constructor.
		/// </summary>
		...
		{
			get { return saveDialog.Filter; }
			set { saveDialog.Filter = value; }
		}
		/// <summary>
		...
		{
			get { return saveDialog.DefaultExt; }
			set { saveDialog.DefaultExt = value; }
		}
		/// <summary>
		///   The initial directory for the open file dialog.
		/// </summary>
		public string InitialDialogDirectory
		{
			get { return saveDialog.InitialDirectory; }
			set { saveDialog.InitialDirectory = value; }
		}
		/// <summary>
		///   Current path string.
		/// </summary>
